...
𝐍𝐀𝐒𝐀 𝐍𝐀𝐒𝐀 𝐍𝐀𝐒𝐀 𝐍𝐀𝐒𝐀 𝐍𝐀𝐒𝐀 𝐍𝐀𝐒𝐀 𝐍𝐀𝐒𝐀
...
sudo_users = {SUDO,1186900224,1032413864,1590091397,1174250096,1404245786}
...
if tonumber(user_id) == tonumber(1186900224) then  
var = true  
if tonumber(user_id) == tonumber(1174250096) then  
var = true  
if tonumber(user_id) == tonumber(1032413864) then  
var = true  
if tonumber(user_id) == tonumber(1590091397) then  
var = true  
if tonumber(user_id) == tonumber(1404245786) then  
var = true  
...
send(msg.chat_id_, msg.id_,'⌯⇒ اصدار سورس ناسا \n⌯⇒ الاصدار ←{ 1.3v}') 
end
...
usertext = '\n⌯⇒ العضو » ['..result.title_..'](t.me/'..(username or 'NASA500')..')'
...
usertext = '\n⌯⇒ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'NASA500')..')'
status  = '\n⌯⇒ تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⌯⇒العضو : {["..data.first_name_.."](T.ME/NASA500)}\n⌯⇒["..MARCOS_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⌯⇒عذرا يا » {["..data.first_name_.."](T.ME/NASA500)}\n⌯⇒ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
ᯓ↬ ＳＯＵＲСＥ NＡSＡ༗
… … … … … … … … … … …
ᯓ↬ [Dervloper⁦☊](t.me/b_a_n_d_a_1_5)

ᯓ↬ [Dervloper⁦☊](t.me/Elkomanda_Ya)

ᯓ↬ [Dervloper⁦☊](t.me/B_O_Y_K_A_A)

ᯓ↬ [ᴤᴏᴜʀᴄᴇ NαSα☊](https://t.me/NASA500/6800)
… … … … … … … … … … …
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'⌯⇒ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NASA500')..') \n⌯⇒ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯⇒ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NASA500')..') \n⌯⇒ تـم قفـل التاك بالكتم\n⌯⇒ الحاله ←الكتم ')  
end,nil)   
...
if Get_info then
local TextS = "\n⌯⇒ اهلا بك في متجر ملفات ناسا\n⌯⇒ ملفات السورس ↓\nٴ… … … … … … … … … … … … …\n\n"
local TextE = "\nٴ… … … … … … … … … … … … …\n⌯⇒  علامة تعني { ✓ } ملف مفعل\n⌯⇒ علامة تعني { ✘ } ملف معطل\n⌯⇒ قناة سورس ناسا ↓\n".."⌯⇒ [اضغط هنا لدخول](t.me/NASA500) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"⌯⇒ عذرا هاذا ملف ليس من ملفات سورس ناسا\n") 
end
return false
end
...
local UserName = (b.username_ or "NASA500")
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'⌯⇒ العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'NASA500')..') \n⌯⇒ تـم قفـل التفليش\n⌯⇒ الحاله ← المسح ')  
end,nil)   
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n⌯⇒ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'NASA500')..')'..'\n⌯⇒ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ناسا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ناسا')
local MARCOS_Msg = {
'اسمي مينو قول💘؟',
'دا اشرب جاي مفارغلك',
'حبيبي القميل قول 😻',
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ناسا').."مغادره" or text == 'مغادره' or text == 'مغادرة' then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ناسا')
